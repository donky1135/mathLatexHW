...
#converts an int n < 2^k to it's binary representation, with padding up to 
...
#Bin(F,L): converts a function on hte integers mod 2^k to a function on binary words
