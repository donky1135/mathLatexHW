...
#CycS(u): inputs a list and outputs all of the cyclic permutations of the list
...
#IsCC tests whether a given linear code over GF(q) generated by M is cyclic or not
...
Mul := proc(q,P1,P2,x,f):
    rem(P1*P2,f,x) mod q 
end:

Irreds := proc(q,f,x) local d,S:
    d := degree(f,x):
    S := AllPols(q,d-1,x):